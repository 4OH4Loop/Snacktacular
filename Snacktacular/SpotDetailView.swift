...
struct SpotDetailView: View {
    ...
    @State private var alertMessage = "Cannot add photo until you save the Spot."
    ...
    var body: some View {
        ...
        .alert(alertMessage, isPresented: $showingAlert) {
            ...
            Button("Save") {
                // We want to return spot.id after saving a new Spot. Right now it's a nil
                Task {
...
#Preview {
    NavigationStack {
        SpotDetailView(spot: Spot(id: "1", name: "Boston Public Makret", address: "Boston, MA"))
    }
}
